"""
Django settings for still_cloud_42320 project.
...
ROOT_URLCONF = 'still_cloud_42320.urls'
...
WSGI_APPLICATION = 'still_cloud_42320.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "still_cloud_42320 API",
    "DESCRIPTION": "API documentation for still_cloud_42320 App",
    "VERSION": "v1",
}
